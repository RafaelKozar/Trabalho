document.addEventListener('DOMContentLoaded', function () {
    ...
    var meuStream = function (connect) {
    ...
    var showRemoteStream = function (stream) {
        if (stream) remoteVideo.src = window.URL.createObjectURL(stream);
    };
    
    // set caller ID and connect to the PeerJS server
    var connect = function (idcon, dial) {
        callerId = idcon;
